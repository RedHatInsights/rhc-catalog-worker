...
const fmtSpec string = "[%s] [id=%s] %s"

// Printf logs a message with variables at level Info
func (l Logger) Printf(s string, args ...interface{}) {
	log.Printf(fmtSpec, callerInfo(), l, fmt.Sprintf(s, args...))
}

// Println logs a message at level Info
func (l Logger) Println(s string) {
	log.Printf(fmtSpec, callerInfo(), l, s)
}
...
func (l Logger) Errorf(s string, args ...interface{}) {
	log.Errorf(fmtSpec, callerInfo(), l, fmt.Sprintf(s, args...))
}

// Error logs a message at level Error
func (l Logger) Error(s string) {
	log.Errorf(fmtSpec, callerInfo(), l, s)
}
